package github.com.br.jordihofc.airline.sycronized;
...
@RestController
public class ReservaPoltronaSyncronizedController {
    @Autowired
    private PoltronaRepository repository;

    @Transactional
    @PostMapping("api/v1/poltronas/{id}/reservas")
    public synchronized ResponseEntity<?> reservar(@PathVariable Long id, @RequestParam @NotBlank String usuario){
