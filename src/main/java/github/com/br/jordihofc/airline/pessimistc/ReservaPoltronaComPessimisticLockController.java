package github.com.br.jordihofc.airline.pessimistc;
...
@RestController
public class ReservaPoltronaComPessimisticLockController {
    @Autowired
    ...
    public ResponseEntity<?> reservar(@PathVariable Long id, @RequestParam @NotBlank String usuario){
        ...
        Poltrona poltrona = repository.findByIdWithPessimisticLock(id)
